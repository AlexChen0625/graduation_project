...
import com.parrot.arsdk.arcontroller.ARFeatureFollowMe;
...
import static com.parrot.arsdk.arcommands.ARCOMMANDS_ARDRONE3_PILOTING_MOVETO_ORIENTATION_MODE_ENUM.ARCOMMANDS_ARDRONE3_PILOTING_MOVETO_ORIENTATION_MODE_HEADING_DURING;
...
public class BebopDrone {
    ...
    public static float cameraMinTilt;
    public static float cameraMaxTilt;
    public static float cameraMinPan;
    public static float cameraMaxPan;
    public static float droneYaw;
    public static float dronePan;
    public static float cameraTilt;
    public static float cameraPan;
    ...
    public void startFollow() {
        if ((mDeviceController != null) && (mState.equals(ARCONTROLLER_DEVICE_STATE_ENUM.ARCONTROLLER_DEVICE_STATE_RUNNING))) {
            mDeviceController.getFeatureFollowMe().sendStart(ARCOMMANDS_FOLLOW_ME_MODE_ENUM.LOOK_AT);
        }
    }

    public void stopFollow() {
        if ((mDeviceController != null) && (mState.equals(ARCONTROLLER_DEVICE_STATE_ENUM.ARCONTROLLER_DEVICE_STATE_RUNNING))) {
            mDeviceController.getFeatureFollowMe().sendStop();
        }
    }

    public void setRelative() {
        if ((mDeviceController != null) && (mState.equals(ARCONTROLLER_DEVICE_STATE_ENUM.ARCONTROLLER_DEVICE_STATE_RUNNING))) {
            mDeviceController.getFeatureFollowMe().sendConfigureGeographic((byte)0, (float)2, (float)-1, (float)1.5);
        }
    }

    public void setFrame() {
        if ((mDeviceController != null) && (mState.equals(ARCONTROLLER_DEVICE_STATE_ENUM.ARCONTROLLER_DEVICE_STATE_RUNNING))) {
            mDeviceController.getFeatureFollowMe().sendTargetFramingPosition((byte)50, (byte)50);
        }
    }

    public void setGps(double latitude, double longitude, float altitude, float horizontal_accuracy, float vertical_accuracy, float north_speed, float east_speed, float down_speed, double timestamp){
        if ((mDeviceController != null) && (mState.equals(ARCONTROLLER_DEVICE_STATE_ENUM.ARCONTROLLER_DEVICE_STATE_RUNNING))) {
            mDeviceController.getFeatureControllerInfo().sendGps(latitude, longitude, altitude, horizontal_accuracy, vertical_accuracy, north_speed, east_speed, down_speed, timestamp);
        }
    }

    public void setDetect(float horizAngle, float vertAngle, Byte isNew){
        mDeviceController.getFeatureFollowMe().sendTargetImageDetection(horizAngle, vertAngle, 1, (byte) 255, (byte) isNew, System.currentTimeMillis());
    }

    public void setBarometer(float f) {
        if ((mDeviceController != null) && (mState.equals(ARCONTROLLER_DEVICE_STATE_ENUM.ARCONTROLLER_DEVICE_STATE_RUNNING))) {
            mDeviceController.getFeatureControllerInfo().setBarometer(f, System.currentTimeMillis());
        }
    }

    public void setMoveTo(double latitude, double longitude, double altitude, float heading){
        mDeviceController.getFeatureARDrone3().sendPilotingMoveTo(latitude, longitude, altitude, ARCOMMANDS_ARDRONE3_PILOTING_MOVETO_ORIENTATION_MODE_HEADING_START, heading);
    }
     ...
     */
    public String getOneLastFlightMedias() {
        String s;
        s = mSDCardModule.getOneMedia();
        return s; //return media name to activity
    }
    ...
    private final ARDeviceControllerListener mDeviceControllerListener = new ARDeviceControllerListener() {
        ...
        public void onCommandReceived(ARDeviceController deviceController, ARCONTROLLER_DICTIONARY_KEY_ENUM commandKey, ARControllerDictionary elementDictionary) {
            ...
            // if event received is the run id
            ...
            else if ((commandKey == ARCONTROLLER_DICTIONARY_KEY_ENUM.ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_STATE) && (elementDictionary != null)){
                ARControllerArgumentDictionary<Object> args = elementDictionary.get(ARControllerDictionary.ARCONTROLLER_DICTIONARY_SINGLE_KEY);
                if (args != null) {
            ...
            else if ((commandKey == ARCONTROLLER_DICTIONARY_KEY_ENUM.ARCONTROLLER_DICTIONARY_KEY_FOLLOW_ME_MODEINFO)){
                ...
                if (args != null) {
                    ...
                    cameraMaxPan = panMax;
                    cameraMaxTilt = tiltMax;
                    cameraMinPan = panMin;
                    cameraMinTilt = tiltMin;
                }
            }
